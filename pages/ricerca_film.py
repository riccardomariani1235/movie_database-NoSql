"""
Pagina Streamlit del catalogo film ("Ricerca Film").

L'app si avvia sempre con `streamlit run app.py`: è lì che st.navigation
registra questa pagina con il suo titolo. La navigazione tra elenco e scheda
avviene tramite un parametro nell'URL (`film_id`), la stessa convenzione con
cui la scheda si collega alla pagina persona.
"""
